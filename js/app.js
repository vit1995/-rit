 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".author__slider")) new core(".author__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".gallery-slider__slider ")) {
                const thumbsSwiper = new core(".gallery-slider-tumb__slider", {
                ...
                new core(".gallery-slider__slider ", {
                    modules: [ Navigation, Thumb, Autoplay ],
                    thumbs: {
                        swiper: thumbsSwiper
                    },
